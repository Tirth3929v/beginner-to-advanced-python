...
class Food(t.Turtle):
    ...
    def __init__(self):
        ...
        self.shape("circle")
        self.penup()
        # Scale default 20x20 turtle shape down to 12x12 pixels for better proportion
    ...
    def refresh(self) -> None:
        """Relocates food to random grid-aligned coordinates within the expanded 800x600 arena."""
