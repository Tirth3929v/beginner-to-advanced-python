...
def banner():
    ...
    print("=" * 70)
    print(f" 🚀 DAY 98: CUSTOM AUTOMATION SCRIPTING CAPSTONE")
    print(f" 📚 Phase 5: Portfolio | 100 Days of Code Python Bootcamp")
    print("=" * 70)
    print(f"Key Concepts: OS/Shutil File System Automation, File Organizer, System Monitoring Engine\n")
...
def run_project():
    ...
    print(f"To explore and extend this project, check README.md in Day 98/.\n")
    print("Happy Coding! ✨\n")
